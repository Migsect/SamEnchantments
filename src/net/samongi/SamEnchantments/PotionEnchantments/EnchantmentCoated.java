...
public class EnchantmentCoated extends LoreEnchantment implements OnEntityArrowHitEntity
{

  @SuppressWarnings("unused")
  private JavaPlugin plugin;
  
  public EnchantmentCoated(JavaPlugin plugin)
  {
    super("Coated");
    this.plugin = plugin;
  }
  ...
  @Override
  public void onEntityArrowHitEntity(EntityDamageByEntityEvent event,
      String[] data)
  {
