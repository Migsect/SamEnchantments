...
public class EnchantmentExplosive extends LoreEnchantment implements OnEntityArrowHitEntity, OnBlockArrowHit
{
  ...
  public void onBlockArrowHit(ProjectileHitEvent event, LoreEnchantment ench, String[] data)
  {
    ...
    arrow.getWorld().createExplosion(loc.getX(), loc.getY(), loc.getZ(), (float) explosion_power, this.set_fire, this.destroy_blocks);
